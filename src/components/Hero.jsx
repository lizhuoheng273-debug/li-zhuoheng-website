        ...
        <div className="hero-grid">
          <div className="hero-left">
            ...
            <p className="hero-bio">
              {isEn ? <><b>Master of FinTech candidate at The University of Hong Kong</b>, with an undergraduate degree from Shenzhen University and Audencia Business School. I follow AI developments and bring hands-on experience in AI product building and investment analysis. With foundations in industry research and business analysis, I aim to deepen my work at the intersection of AI and finance.</> : <><b>香港大学金融科技硕士，本科毕业于深圳大学与Audencia商学院</b><br />持续关注 AI 前沿动态，具备 AI 产品搭建与投资分析实践经验 掌握行业研究与商业分析基本技能，期望在AI与金融交叉领域深耕</>}
            </p>
