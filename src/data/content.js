...
export const projects = [
  {
    ...
    desc: '基于开源投研看板二次开发的金融 × AI 研究工作台：整合 AI 热点资讯、证据优先的财经新闻、每日市场复盘与上下文连续的 AI 会话，支持 Owner/Guest 双角色隔离与腾讯云部署。',
...
export const projectsEn = [
  { icon: '❖', title: 'FT-Research', detailId: 'ft-research', desc: 'A finance × AI research workbench built on an open-source dashboard: AI news, evidence-first financial feeds, daily market review, and context-aware AI sessions, with owner/guest isolation and Tencent Cloud deployment.', tags: ['FinTech', 'GLM', 'Streaming', 'Auth', 'Deployment'], cta: 'https://github.com/lizhuoheng273-debug/FT-Research', ctaText: 'Open project' },
